...
public class DynamicMusicHelper {
    ...
    private static Map<String, SoundEvent> getRecords() {
        ...
        for (String recordName : recordNames) {
            out.put(recordName, SoundEvent.createVariableRangeEvent(new ResourceLocation("minecraft", "music_disc." + recordName)));
        }
    ...
    public static Map<String, SoundEvent> getMusics() {
        ...
        for (String musicName : musicNames) {
            out.put(musicName, SoundEvent.createVariableRangeEvent(new ResourceLocation(DynamicMusic.MOD_ID, "music." + musicName)));
        }
    ...
    private static Map<String, MusicToggle> getMusicTogglesForType(MusicType type) {
        return switch (type) {
            case Cave -> Map.ofEntries(
                    ...
                    Map.entry("aerie", DynamicMusic.config.musicSelector.caveMusic.aerie),
                    Map.entry("ancestry", DynamicMusic.config.musicSelector.caveMusic.ancestry),
                    ...
                    Map.entry("firebugs", DynamicMusic.config.musicSelector.caveMusic.firebugs),
                    ...
                    Map.entry("labyrinthine", DynamicMusic.config.musicSelector.caveMusic.labyrinthine),
            ...
            case Cold -> Map.ofEntries(
                    ...
                    Map.entry("aerie", DynamicMusic.config.musicSelector.coldMusic.aerie),
                    Map.entry("ancestry", DynamicMusic.config.musicSelector.coldMusic.ancestry),
                    ...
                    Map.entry("firebugs", DynamicMusic.config.musicSelector.coldMusic.firebugs),
                    ...
                    Map.entry("labyrinthine", DynamicMusic.config.musicSelector.coldMusic.labyrinthine),
            ...
            case Hot -> Map.ofEntries(
                    ...
                    Map.entry("aerie", DynamicMusic.config.musicSelector.hotMusic.aerie),
                    Map.entry("ancestry", DynamicMusic.config.musicSelector.hotMusic.ancestry),
                    ...
                    Map.entry("firebugs", DynamicMusic.config.musicSelector.hotMusic.firebugs),
                    ...
                    Map.entry("labyrinthine", DynamicMusic.config.musicSelector.hotMusic.labyrinthine),
            ...
            case Nice -> Map.ofEntries(
                    ...
                    Map.entry("aerie", DynamicMusic.config.musicSelector.niceMusic.aerie),
                    Map.entry("ancestry", DynamicMusic.config.musicSelector.niceMusic.ancestry),
                    ...
                    Map.entry("firebugs", DynamicMusic.config.musicSelector.niceMusic.firebugs),
                    ...
                    Map.entry("labyrinthine", DynamicMusic.config.musicSelector.niceMusic.labyrinthine),
            ...
            case Down -> Map.ofEntries(
                    ...
                    Map.entry("aerie", DynamicMusic.config.musicSelector.downMusic.aerie),
                    Map.entry("ancestry", DynamicMusic.config.musicSelector.downMusic.ancestry),
                    ...
                    Map.entry("firebugs", DynamicMusic.config.musicSelector.downMusic.firebugs),
                    ...
                    Map.entry("labyrinthine", DynamicMusic.config.musicSelector.downMusic.labyrinthine),
