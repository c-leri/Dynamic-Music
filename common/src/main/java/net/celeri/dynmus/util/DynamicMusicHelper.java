...
public class DynamicMusicHelper {
    ...
    private static final List<String> musicNames = List.of(
        ...
        "aerie", "ancestry", "an_ordinary_day", "a_familiar_room",
        "bromeliad", "comforting_memories", "crescent_dunes",
        "echo_in_the_wind", "firebugs", "floating_dream",
    ...
    private static Map<String, SoundEvent> getRecords() {
        return recordNames.stream().collect(
            Collectors.toMap(
                ...
                recordName -> SoundEvent.createVariableRangeEvent(new ResourceLocation("minecraft", "music_disc." + recordName))
            )
        );
    }
    ...
    public static Map<String, SoundEvent> getMusics() {
        return musicNames.stream().collect(
            Collectors.toMap(
                musicName -> musicName,
                musicName -> SoundEvent.createVariableRangeEvent(new ResourceLocation(DynamicMusic.MOD_ID, "music." + musicName))
            )
        );
    }

    private static Map<String, SoundEvent> getMusicsAndRecords() {
        Map<String, SoundEvent> out = new HashMap<>();
    ...
    private static Map<String, MusicToggle> getMusicTogglesForType(MusicType type) {
        ...
        return switch (type) {
            case Cave -> Map.<String, MusicToggle>ofEntries(
                ...
                Map.entry("a_familiar_room", config.musicSelector.caveMusic.a_familiar_room),
                Map.entry("an_ordinary_day", config.musicSelector.caveMusic.an_ordinary_day),
                Map.entry("bromeliad", config.musicSelector.caveMusic.bromeliad),
                Map.entry("comforting_memories", config.musicSelector.caveMusic.comforting_memories),
                Map.entry("crescent_dunes", config.musicSelector.caveMusic.crescent_dunes),
                Map.entry("echo_in_the_wind", config.musicSelector.caveMusic.echo_in_the_wind),
                ...
                Map.entry("relic", config.musicSelector.caveMusic.relic),
            ...
            case Cold -> Map.<String, MusicToggle>ofEntries(
                ...
                Map.entry("a_familiar_room", config.musicSelector.coldMusic.a_familiar_room),
                Map.entry("an_ordinary_day", config.musicSelector.coldMusic.an_ordinary_day),
                Map.entry("bromeliad", config.musicSelector.coldMusic.bromeliad),
                Map.entry("comforting_memories", config.musicSelector.coldMusic.comforting_memories),
                Map.entry("crescent_dunes", config.musicSelector.coldMusic.crescent_dunes),
                Map.entry("echo_in_the_wind", config.musicSelector.coldMusic.echo_in_the_wind),
                ...
                Map.entry("relic", config.musicSelector.coldMusic.relic),
            ...
            case Hot -> Map.<String, MusicToggle>ofEntries(
                ...
                Map.entry("a_familiar_room", config.musicSelector.hotMusic.a_familiar_room),
                Map.entry("an_ordinary_day", config.musicSelector.hotMusic.an_ordinary_day),
                Map.entry("bromeliad", config.musicSelector.hotMusic.bromeliad),
                Map.entry("comforting_memories", config.musicSelector.hotMusic.comforting_memories),
                Map.entry("crescent_dunes", config.musicSelector.hotMusic.crescent_dunes),
                Map.entry("echo_in_the_wind", config.musicSelector.hotMusic.echo_in_the_wind),
                ...
                Map.entry("relic", config.musicSelector.hotMusic.relic),
            ...
            case Nice -> Map.<String, MusicToggle>ofEntries(
                ...
                Map.entry("a_familiar_room", config.musicSelector.niceMusic.a_familiar_room),
                Map.entry("an_ordinary_day", config.musicSelector.niceMusic.an_ordinary_day),
                Map.entry("bromeliad", config.musicSelector.niceMusic.bromeliad),
                Map.entry("comforting_memories", config.musicSelector.niceMusic.comforting_memories),
                Map.entry("crescent_dunes", config.musicSelector.niceMusic.crescent_dunes),
                Map.entry("echo_in_the_wind", config.musicSelector.niceMusic.echo_in_the_wind),
                ...
                Map.entry("relic", config.musicSelector.niceMusic.relic),
            ...
            case Down -> Map.<String, MusicToggle>ofEntries(
                ...
                Map.entry("a_familiar_room", config.musicSelector.downMusic.a_familiar_room),
                Map.entry("an_ordinary_day", config.musicSelector.downMusic.an_ordinary_day),
                Map.entry("bromeliad", config.musicSelector.downMusic.bromeliad),
                Map.entry("comforting_memories", config.musicSelector.downMusic.comforting_memories),
                Map.entry("crescent_dunes", config.musicSelector.downMusic.crescent_dunes),
                Map.entry("echo_in_the_wind", config.musicSelector.downMusic.echo_in_the_wind),
                ...
                Map.entry("relic", config.musicSelector.downMusic.relic),
            ...
            case End -> Map.<String, MusicToggle>ofEntries(
                ...
                Map.entry("a_familiar_room", config.musicSelector.endMusic.a_familiar_room),
                Map.entry("an_ordinary_day", config.musicSelector.endMusic.an_ordinary_day),
                Map.entry("bromeliad", config.musicSelector.endMusic.bromeliad),
                Map.entry("comforting_memories", config.musicSelector.endMusic.comforting_memories),
                Map.entry("crescent_dunes", config.musicSelector.endMusic.crescent_dunes),
                Map.entry("echo_in_the_wind", config.musicSelector.endMusic.echo_in_the_wind),
                ...
                Map.entry("relic", config.musicSelector.endMusic.relic),
